...
export function Button({ children, onClick }: ButtonProps) {
    return (
        <button
            data-vaul-no-drag=""
            onClick={onClick}
            className="cursor-pointer flex h-12 w-full items-center gap-[15px] rounde-[16px] bg-[#F7F8F9] px-4 text-[17px] font-semibold text-[#222222] transition-transform focus:scale-95"
        >
            {children}
        </button>
    )
...
export function Phrase({ setView }: ContentProps) {
    return (
        <div>
            <div className="px-2">
                <Header
...
export function Key({ setView }: ContentProps) {
    return (
        <div>
            <div className="px-2">
                <Header
...
export function RemoveWallet({ setView }: ContentProps) {
    return (
        <div>
            <div className="px-2">
                <Header
...
export function DefaultView({ setView }: ContentProps) {
    return (
        <>
            ...
            <div className="space-y-3">
                ...
                <button
                    className=" cursor-pointer flex h-12 w-full items-center gap-[15px] rounded-[16px] bg-[#FFF0F0] px-4 text-[17px] font-semibold text-[#FF3F40] transition-transform focus:scale-95 focus-visible:shadow-focus-ring-button active:scale-95 md:font-medium"
                    onClick={() => {
                        setView('remove')
                    }}
                >
